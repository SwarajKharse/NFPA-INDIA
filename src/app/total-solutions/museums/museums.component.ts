...
export class MuseumsComponent {
  solutions = [
    ...
    {
      id: 4,
      name: 'Fire Suppression Systems (Clean Agent, CO2, Foam)',
    ...
    },
    {
      ...
      description: 'Electrical Panel Suppression systems provide targeted fire protection for electrical equipment, quickly detecting and extinguishing fires at their source to prevent widespread damage and power disruptions in critical facilities.',
      image: 'EPSuppression.webp',
    }
  ];
