...
@Component({
  selector: 'app-fire-sprinkler-system',
  standalone: true,
  imports: [],
  templateUrl: './fire-sprinkler-system.component.html',
  styleUrl: './fire-sprinkler-system.component.css',
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class FireSprinklerSystemComponent implements AfterViewInit {
