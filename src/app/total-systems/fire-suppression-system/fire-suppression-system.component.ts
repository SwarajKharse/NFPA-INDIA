...
@Component({
  selector: 'app-fire-suppression-system',
  standalone: true,
  imports: [],
  templateUrl: './fire-suppression-system.component.html',
  styleUrls: ['./fire-suppression-system.component.css'],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class FireSuppressionSystemComponent implements AfterViewInit {
